...
export default function LayoutWrapper({ children, title, subtitle }: LayoutWrapperProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black transition-colors">
      ...
      <MobileHeader title={title} subtitle={subtitle} onMenuClick={handleSidebarToggle} />
      <div
        className={`${isManualToggle ? 'transition-all duration-300 ease-in-out' : ''} ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 text-sm">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="font-mono text-gray-900 dark:text-white">
                    {parseInt(networkInfo.blockHeight).toLocaleString()}
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider">
                  ...
                  <span className="font-mono text-gray-900 dark:text-white">
                    {parseFloat(networkInfo.totalSupply).toLocaleString()} VNA
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="font-mono text-gray-900 dark:text-white">
                    {parseFloat(networkInfo.trustDepositSize).toLocaleString()} VNA
                  </span>
                </div>
              </div>
            </div>
