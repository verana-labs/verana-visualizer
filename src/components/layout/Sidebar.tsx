...
export default function Sidebar({ isCollapsed, onToggle, isLoaded = true, isManualToggle = false }: SidebarProps) {
  ...
  return (
    <>
      {!isCollapsed && <div className="fixed inset-0 bg-black bg-opacity-50 z-40 lg:hidden" onClick={onToggle} />}
      <div
        className={`
          ...
          {!isCollapsed && (
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 flex items-center justify-center">
                <Image src="/logo.svg" alt="Verana Logo" width={32} height={32} className="w-8 h-8" priority />
              </div>
              <div>
