...
export default function RefreshButton({ onRefresh, isRefreshing, autoRefreshInterval = 550 }: RefreshButtonProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        >
          <div
            className={`w-2 h-2 rounded-full ${isAutoRefreshEnabled ? 'bg-green-500 animate-pulse' : 'bg-gray-400'}`}
          />
