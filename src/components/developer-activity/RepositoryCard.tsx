...
import { formatCommitActivityForChart, formatNumber, formatRelativeTime } from '@/lib/githubApi'
    ...
    <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-200 overflow-hidden flex flex-col">
      <div className="p-6 flex-1 min-h-[320px] flex flex-col justify-between">
        <div className="flex-1">
          ...
          {/* Description */}
          {repo.description && (
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 line-clamp-2">{repo.description}</p>
          )}
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-gray-700 dark:text-gray-300 font-medium">{formatNumber(repo.stars)}</span>
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-gray-700 dark:text-gray-300 font-medium">{formatNumber(repo.forks)}</span>
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-gray-700 dark:text-gray-300 font-medium">{repo.totalCommits}</span>
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-gray-700 dark:text-gray-300 font-medium">{repo.contributors.length}</span>
      ...
      <div
        className={`border-t border-gray-200 dark:border-gray-700 transition-all duration-300 ease-in-out ${
          isExpanded ? 'max-h-[400px] opacity-100' : 'h-12 opacity-100'
        }`}
      >
        {isExpanded ? (
          <div className="p-4 bg-gray-50 dark:bg-gray-800/50">
            <CommitActivityChart data={chartData} repoName={repo.name} />
          </div>
        ) : (
