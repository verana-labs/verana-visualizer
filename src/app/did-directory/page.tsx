...
function DIDDirectoryContent() {
  ...
  return (
    <LayoutWrapper title="DID Directory" subtitle="Explore and manage decentralized identifiers">
      <div className="p-6">
        <SearchForm
        ...
        {isLoading ? (
          <div className="bg-white dark:bg-dark-card rounded-lg shadow-lg p-6">
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Loading DID Directory</h3>
          ...
          <DIDTable dids={filteredDids} isSearchResult={!!searchTerm} selectedDid={didParam} />
        )}
