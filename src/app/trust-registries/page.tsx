...
export default function TrustRegistriesPage() {
  ...
  return (
    <LayoutWrapper title="Trust Registries" subtitle="Explore and manage trust registries">
      <div className="p-6">
        ...
        {isLoading ? (
          <div className="bg-white dark:bg-dark-card rounded-lg shadow-lg p-6">
            <div className="text-center py-12">
              <div className="w-16 h-16 mx-auto mb-4 bg-gray-100 dark:bg-dark-surface rounded-full flex items-center justify-center">
                <svg
                  className="w-8 h-8 text-verana-accent animate-spin"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Loading Trust Registries</h3>
              <p className="text-gray-500 dark:text-gray-400">Fetching data from the Verana network...</p>
            </div>
          </div>
        ) : error ? (
          <div className="bg-white dark:bg-dark-card rounded-lg shadow-lg p-6">
          ...
          <TrustRegistryTable trustRegistries={filteredRegistries} isSearchResult={!!searchTerm} />
        )}
