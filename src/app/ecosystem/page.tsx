...
export default function EcosystemPage() {
  ...
  return (
    <LayoutWrapper title="Ecosystem Health" subtitle="SSI Growth & Trust Metrics">
      <div className="p-6">
        {/* Header */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Ecosystem Health</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <EcosystemGrowthChart data={historicalData} isLoading={historicalData.length === 0 && isLoadingCharts} />
