            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className={`text-lg font-semibold mb-2 ${
                  ...
                  {hasGitHubToken() ? 'GitHub Token Configured ✓' : 'About This Data'}
                </h3>
                <div className={`text-sm space-y-1 ${
                  ...
                  <p>
                    • Data is fetched live from the <strong>GitHub API</strong> for the <strong>{ORGANIZATION}</strong> organization
                  </p>
                  <p>
                    • Showing <strong>original repositories only</strong> (forks are excluded)
                  </p>
                  <p>
                    • Commit statistics show activity from the <strong>last 30 days</strong>
                  </p>
                  <p>
                    • API Rate Limit: <strong>{hasGitHubToken() ? '5,000 requests/hour (authenticated)' : '60 requests/hour (unauthenticated)'}</strong>
                  </p>
                  {!hasGitHubToken() && (
                    <p className="pt-2 border-t border-amber-300 dark:border-amber-700 mt-2">
                      💡 <strong>Want higher rate limits?</strong> Add a GitHub token to <code className="bg-amber-200 dark:bg-amber-800 px-1 py-0.5 rounded">.env.local</code>
                    </p>
                  )}
                  <p>
                    • Click on repository names or contributor avatars to view their GitHub profiles
                  </p>
                  <p>
                    • Use the <strong>Refresh</strong> button to update data manually
                  </p>
                </div>
              </div>
            </div>
